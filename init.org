...
** Load Private File
   ...
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "InitPrivate" :range-end "-InitPrivate"  :lines "243-246"
* Package Management
...
** Prettify Symbols
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-ui-config.el" src emacs-lisp :range-begin "PreSym" :range-end "-PreSym" :lines "42-54"
** UI Configs
*** Title Bar
    #+INCLUDE: "~/.emacs.d/elisp/init-ui-config.el" src emacs-lisp :range-begin "TitleBar" :range-end "-TitleBar" :lines "57-58"
*** Simplify Yes/No Prompts
    #+INCLUDE: "~/.emacs.d/elisp/init-ui-config.el" src emacs-lisp :range-begin "YorN" :range-end "-YorN" :lines "61-63"
*** Disable Splash Screen
    #+INCLUDE: "~/.emacs.d/elisp/init-ui-config.el" src emacs-lisp :range-begin "StartupScreen" :range-end "-StartupScreen" :lines "66-70"
*** Line Numbers
...
** Golang
   ...
   *Prerequisite*: [[https://github.com/golang/tools/blob/master/gopls/README.md][gopls]] is suggested for Golang's LSP support.
   #+BEGIN_SRC bash
...
** Yaml
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-buildsystem.el" src emacs-lisp :range-begin "YamlPac" :range-end "-YamlPac" :lines "52-53"
** Buildsystem
*** Docker
...
** EAF
   ...
   *Prerequisite*: Please ensure =python3= and =pip3= are installed, then follow [[https://github.com/manateelazycat/emacs-application-framework#install][install]] instructions.
   ...
   #+END_SRC
   #+INCLUDE: "~/.emacs.d/elisp/init-eaf.el" src emacs-lisp :range-begin "EAFPac" :range-end "-EAFPac" :lines "42-79"
** ERC
