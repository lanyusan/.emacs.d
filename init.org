...
** Load Private File
   ...
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "InitPrivate" :range-end "-InitPrivate"  :lines "260-263"
...
** Melpa Packages
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-package.el" src emacs-lisp :range-begin "MelpaPackages" :range-end "-MelpaPackages" :lines "40-51"
** Non-Melpa Packages
...
** Auto Package Update
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-package.el" src emacs-lisp :range-begin "AutoPackageUpdate" :range-end "-AutoPackageUpdate" :lines "82-91"
** Diminish
...
*** Small Configs
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "SmallConfigs" :range-end "-SmallConfigs" :lines "153-207"
** Functions
   Important functions.
...
** Projectile
   ...
   *Prerequisite*: Windows OS: Install [[https://github.com/bmatzelle/gow/releases][Gow]] and ensure it's in =PATH=.
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-projectile.el" src emacs-lisp :range-begin "ProjPac" :range-end "-ProjPac" :lines "42-58"
** YASnippet
*** YASnippet
...
** Completion / LSP
   Instead of the popular [[http://company-mode.github.io/][Company]], I opt-ed to use [[https://github.com/manateelazycat/lsp-bridge][lsp-bridge]] that is completely *multi-threading* technology, handles almost all of my completion needs.
    #+INCLUDE: "~/.emacs.d/elisp/init-complete.el" src emacs-lisp :range-begin "LSPPac" :range-end "-LSPPac" :lines "42-73"
